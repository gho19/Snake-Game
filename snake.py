...
class cube(object):
    ...
    def draw(self, surface, eyes = False):
        ...
        if eyes:
            ...
            pygame.draw.circle(surgace, (0, 0, 0), circleMiddle2, radius)
...
class snake(object):
    ...
    def move(self):
        ...
        for i, c in enumerate(self.body):
            ...
            if p in self.turns:
                turn = self.turns[p]
                c.move(turns[0], turn[1])
                if i == len(self.body) - 1:
                    self.turns.pop(p)

            # movement of snake direction
            else:
    ...
    def addCube(self):
        ...
        # add cube when snake eats snack depending on where snack facing
        if dx == 1 and dy == 0:
...
def randomSnack(rows, items) :
    ...
    # make sure apple doesn't appear on snake
    while True:
